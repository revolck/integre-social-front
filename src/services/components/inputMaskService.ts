/**
 * Serviço para gerenciar máscaras e validações de campos de entrada
 *
 * Este serviço segue o padrão Singleton para garantir que apenas uma
 * instância seja utilizada em toda a aplicação.
 */
